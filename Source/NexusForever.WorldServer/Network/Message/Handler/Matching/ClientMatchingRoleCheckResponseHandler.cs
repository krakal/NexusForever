...
namespace NexusForever.WorldServer.Network.Message.Handler.Matching
{
    public class ClientMatchingRoleCheckResponseHandler : IMessageHandler<IWorldSession, ClientMatchingRoleCheckResponse>
    {
        ...
        {
            IMatchingRoleCheck matchingRoleCheck = matchingManager.GetMatchingRoleCheck(session.Player.Identity.CharacterId);
            ...
            matchingRoleCheck.Respond(session.Player.Identity.CharacterId, matchingRoleCheckResponse.Roles);
        }
    }
}
