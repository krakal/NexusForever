namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        ClientGroupGoToInstance         = 0x0411,
        ClientGroupSetInstanceDifficulty = 0x0412,
        ServerGroupInstanceDifficulty   = 0x0414,
        ClientGroupInvite               = 0x0416,
        ClientGroupInviteResponse       = 0x041A,
        ServerGroupInviteResult         = 0x041D,
        ServerGroupInvited              = 0x041F,
        ClientGroupJoinRequest          = 0x0422,
        ServerGroupJoinRequest          = 0x0424,
        ServerGroupJoin                 = 0x0427,
        ClientGroupKick                 = 0x0428,
        ServerGroupLeaderPhaseChanged   = 0x042A,
        ClientGroupLeave                = 0x042B,
        ServerGroupLeave                = 0x042D,
        ClientGroupSetLootRules         = 0x042E, 
        ServerGroupLootRulesChanged     = 0x042F,
        ServerGroupMarks                = 0x0431,
        ClientGroupSetTargetMark        = 0x0432,
        ServerGroupMatchingPenaltyUpdated = 0x0436,
        ServerGroupMemberFlagsChanged   = 0x0437,
        ServerGroupMemberOrderChanged   = 0x0438,
        ClientCloseMentoringAOIDialog   = 0x0439,
        ServerGroupMentorLeftAOI        = 0x043A,
        ClientGroupMentoringCancel      = 0x043B,
        ClientGroupMentoringAccept      = 0x043E,
        ServerGroupMentoringResult      = 0x0441,
        ServerGroupOperationResult      = 0x0443,
        ClientGroupPromote              = 0x0446,
        ServerGroupMemberPromoted       = 0x0447,
        ClientGroupReadyCheckRequest    = 0x044A,
        ServerGroupReadyCheck           = 0x044C,
        ServerGroupReferral             = 0x044F,
        ServerGroupRemove               = 0x0450,
        ClientGroupJoinResponse         = 0x0453,
        ServerGroupRequestResult        = 0x0456,
        ClientZoneMapPing               = 0x0459,
        ServerZoneMapPing               = 0x045A,                                         
        ServerGroupSetMark              = 0x045B,
        ClientGroupSetOrder             = 0x045C,
        ClientQuestShareResponse        = 0x045E,
        ClientQuestShare                = 0x045F,
        ServerQuestShareResult          = 0x0461,
        ServerGroupMaxSizeChange        = 0x0462,
        ClientGroupSwapOrder            = 0x0463,
        ...
        ServerMatchingStatus            = 0x05E3,
        ServerMatchingMatchStateUpdate  = 0x05EA,
        ...
        ServerPublicEventVoteInitiate   = 0x06FE,
